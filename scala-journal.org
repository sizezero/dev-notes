...
the jdk. I decided to go with the easy route of just setting JAVA_HOME
and running sbt. Once I did this I still got some library errors.

The first set of errors involved calls to String.strim() which was
